...
var import8 = require('../../app/17-AoT编译/root');
var import9 = require('./17-AoT编译/root.ngfactory');
...
var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_1 = import3.createRenderElement(this.renderer, parentRenderNode, 'root', import3.EMPTY_INLINE_ARRAY, null);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import8.RootComponent) && (1 === requestNodeIndex))) {
            return this._RootComponent_1_3.context;
        }
        return notFoundResult;
    };
