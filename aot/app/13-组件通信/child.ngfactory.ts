...
import * as import0 from '../../../app/13-组件通信/child';
...
export class Wrapper_ChildComponent {
  ...
  check_gender(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
...
class View_ChildComponent_Host0 extends import2.AppView<any> {
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ChildComponent_Host0,renderType_ChildComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways);
  }
...
const styles_ChildComponent:any[] = [''];
var renderType_ChildComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.Emulated,styles_ChildComponent,{});
export class View_ChildComponent0 extends import2.AppView<import0.ChildComponent> {
  _text_0:any;
  /*private*/ _expr_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ChildComponent0,renderType_ChildComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways);
    this._expr_1 = import1.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_1:any = import3.inlineInterpolate(2,'姓名：',this.context.name,'，性别：',this.context.gender,'');
