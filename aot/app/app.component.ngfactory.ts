...
import * as import8 from '../../app/17-AoT编译/root';
import * as import9 from './17-AoT编译/root.ngfactory';
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  _text_0:any;
  _el_1:any;
  compView_1:import1.AppView<import8.RootComponent>;
  _RootComponent_1_3:import9.Wrapper_RootComponent;
  _text_2:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_1 = import3.createRenderElement(this.renderer,parentRenderNode,'root',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_1 = new import9.View_RootComponent0(this.viewUtils,this,1,this._el_1);
    this._RootComponent_1_3 = new import9.Wrapper_RootComponent();
    this.compView_1.create(this._RootComponent_1_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import8.RootComponent) && (1 === requestNodeIndex))) { return this._RootComponent_1_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._RootComponent_1_3.ngDoCheck(this,this._el_1,throwOnChange);
